                    ...
                    <div class="col col-xl-5">
                        <div class="card-body p-4">
                            <h1 class="display-1"><span class="text-primary">4</span><span
                                    class="text-danger">0</span><span class="text-success">1</span></h1>
                            <h4 class="font-weight-bold display-4">No tienes Permisos</h4>

                            <p> Por favor, asegúrate de tener los privilegios
                                <br>necesarios para ver este contenido.
                                <br>Si crees que esto es un error, contacta con el administrador del sistema.
                            </p>
                            <div class="mt-5">
                                <a href="{{ route('login') }}"
