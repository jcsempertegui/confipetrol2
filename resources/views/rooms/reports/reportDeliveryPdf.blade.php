...
<body>
    ...
    <div style="text-align: left; margin-top: 30px; margin-left: 335px;">
        <h2 style="font-size: 1.9em; margin: 10;">REPORTE DE ENTREGAS</h2>
    </div>
    ...
    <table class="table-container" style="margin-top: 20px;">
        ...
        <tfoot>
            <tr>
                <td colspan="9" style="text-align: right; font-weight: bold;">TOTAL ITEMS:</td>
                <td style="text-align: left;">{{ $totalItems }} (items)</td>
            </tr>
            <tr>
                <td colspan="9" style="text-align: right; font-weight: bold; border: none;">TOTAL CANTIDAD ENTREGADA:</td>
                <td style="text-align: left;">{{ $totalQuantityDelivered }}</td>
            </tr>
        </tfoot>
    </table>
